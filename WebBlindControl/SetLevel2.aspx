<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SetLevel2.aspx.vb" Inherits="WebBlindControl.SetLevel2" %>
...
<body>
    ...
    <div id="mainContainer" style="text-align:center;" >
        ...
        <div style="text-align:center;">
            <asp:Button ID="btnShadeOpen" runat="server" Text="Shade Open" />
            <br />
            <br />
            <asp:Button ID="btnShadeClose" runat="server" Text="Shade Close" />
            <br />
            <br />
       </div>
       <br />
