<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OnOff2.aspx.vb" Inherits="TestLightControl.WebForm3" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Front Door Coach Lights On/Off</title>
</head>
<body>
    <div><h1>Front Door Coach Lights On/Off</h1></div>
    ...
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:WatchdogConnectionString1 %>" SelectCommand="sp_InsteonRequestStateChange" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:Parameter DefaultValue="15.FD.A1" Name="Device_ID" Type="String" />
